...
{
    //used for storing the one or two numbers gained from converting the four or eight digit binary number, the user inputted, to hexadecimal. The one to two numbers stored in here will be used later in a loop to convert the value or values into the corresponding hexadecimal value(s)
