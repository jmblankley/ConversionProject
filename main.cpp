...
Joshua Blankley, Aaron Jacobsen, Lance Cole
...
{
    // we want to convert char to string
    char hexVal = '\0';
    
    //call bitset template to convert hex to binary.
    bitset<16>binary(std::stoi(std::string(1, hexVal), nullptr, 16));
